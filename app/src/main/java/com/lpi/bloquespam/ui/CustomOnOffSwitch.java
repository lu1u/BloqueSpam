...
public class CustomOnOffSwitch extends View
{
	...
	@NonNull private static final String PROPERTY_VALEUR = "valeur";
	/**
	 ...
	 * Charge un drawable
	 ***********************************************************************************************/
	@Nullable static private Drawable loadDrawable(@NonNull final TypedArray a, final int attr)
	{
		if (a.hasValue(attr))
		{
	...
	protected void onDraw(@NonNull Canvas canvas)
	{
		...
		if (_drawableOff != null)
		{
			...
			_drawableOff.setBounds(left, _topDrawable, right, _bottomDrawable);
