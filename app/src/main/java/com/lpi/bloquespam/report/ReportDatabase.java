...
public class ReportDatabase
{
	...
	@Nullable protected static ReportDatabase INSTANCE = null;
	@NonNull protected final SQLiteDatabase database;
	@NonNull protected final ReportDatabaseHelper dbHelper;
