...
public class ReportDatabaseHelper extends SQLiteOpenHelper
{
	...
	@NonNull public static final String DATABASE_NAME = "debug.db";

	@NonNull public static final String TABLE_TRACES = "TRACES";
	////////////////////////////////////////////////////////////////////////////////////////////////////
	// Table traces
	@NonNull public static final String COLONNE_TRACES_ID = "_id";
	@NonNull public static final String COLONNE_TRACES_DATE = "DATE";
	@NonNull public static final String COLONNE_TRACES_NIVEAU = "NIVEAU";
	@NonNull public static final String COLONNE_TRACES_LIGNE = "LIGNE";
	@NonNull public static final String DATABASE_TRACES_CREATE = "create table "
			+ TABLE_TRACES + "("
